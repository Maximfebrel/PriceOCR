...
Для декодировки последовательности в обеих описанных выше архитектурах использовалась функция decode_greedy, описанная в классе Model в файле *Model.py*, которая использует greedy-декодирование.
